 ...
 *******************************************************************************/
package com.ibm.ws.app.manager.wab.filter;
 ...
 * failed as WebSphere doesn't always resolve the url before invoking a servlet filter.
 * <br>
 * This leads to missed invocations to paths like /./OSGI-INF/*
 * <br>
 * This Servlet filter is registered against a mapping of /* for every WAB we place in the web container.
 */
